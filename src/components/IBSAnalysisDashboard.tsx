  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className={`rounded-xl border p-6 ${
          ...
          <div className={`p-3 rounded-lg inline-block ${
            ...
            <Activity className={isDarkMode ? 'text-blue-400' : 'text-blue-600'} size={24} />
          </div>
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <div className={`p-3 rounded-lg inline-block ${
            ...
            <ClipboardList className={isDarkMode ? 'text-green-400' : 'text-green-600'} size={24} />
          </div>
          <h3 className={`mt-4 text-sm ${
            isDarkMode ? 'text-gray-400' : 'text-gray-500'
          }`}>Bristol Stool Scale</h3>
          <p className={`text-2xl font-semibold ${
            isDarkMode ? 'text-gray-200' : 'text-gray-900'
          }`}>
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <div className={`p-3 rounded-lg inline-block ${
            ...
            <Brain className={isDarkMode ? 'text-purple-400' : 'text-purple-600'} size={24} />
          </div>
          <h3 className={`mt-4 text-sm ${
            isDarkMode ? 'text-gray-400' : 'text-gray-500'
          }`}>IBS Subtype</h3>
        ...
        <div className={`rounded-xl border p-6 ${
          ...
          <div className={`p-3 rounded-lg inline-block ${
            ...
            <AlertTriangle className={isDarkMode ? 'text-orange-400' : 'text-orange-600'} size={24} />
          </div>
          <h3 className={`mt-4 text-sm ${
            isDarkMode ? 'text-gray-400' : 'text-gray-500'
          }`}>ROME IV Criteria</h3>
      ...
      <SectionCard 
        ...
        icon={<Info className={isDarkMode ? 'text-blue-400' : 'text-blue-600'} size={24} />}
      ...
      <SectionCard 
        ...
        icon={<Activity className={isDarkMode ? 'text-blue-400' : 'text-blue-600'} size={24} />}
        isDarkMode={isDarkMode}
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <SectionCard 
          ...
          icon={<Stethoscope className={isDarkMode ? 'text-green-400' : 'text-green-600'} size={24} />}
          isDarkMode={isDarkMode}
        >
          <div className="space-y-4">
            <div>
        ...
        <SectionCard 
          ...
          icon={<FileWarning className={isDarkMode ? 'text-orange-400' : 'text-orange-600'} size={24} />}
          isDarkMode={isDarkMode}
        >
          <div className="space-y-4">
            <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
